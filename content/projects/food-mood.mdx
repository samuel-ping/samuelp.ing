...
title: Food Mood
featured: true
gist: Web app that suggests a restaurant based off your mood!
start: March 2020
end: August 2020
repo: https://github.com/samuel-ping/food-mood
tags: [react.js, express.js, node.js, aws, ci/cd, nginx]
---
...
![food mood v3 landing page](/assets/projects/food-mood-v3.jpg)
